...
summaries = {
    ...
    "tools/": "Capability kernel and domain-specific action modules (ninaflash nucleus).",
    "interfaces/": "Telegram and REST API communication layers.",
    "docs/": "Subsystem-level deep-dives (Guardian, Memory, Router, ninaflash).",
    ...
    "docs/nina_v14_blueprint.md": "Canonical v14.2 system blueprint and component map.",
    "tools/live_monitor.py": "Real-time visual telemetry backend for resource monitoring.",
    "tools/observable_monitor.py": "NINA-Evolve log-parsing and efficiency monitor.",
...
"""
    ...
    md_content += "| Path | Summary | Lifecycle |\n"
    md_content += "|:-----|:--------|:----------|\n"
    core_docs = ["README.md", "ARCHITECTURE.md", "CHANGELOG.md", "AGENTS.md", "nina_context.md", "docs/nina_v14_blueprint.md", "docs/space/nina_state.md", "docs/space/nina_megatask_index.md"]
    for doc in core_docs:
        f_info = next((f for f in files if f["path"] == doc), None)
        if f_info:
            md_content += f"| `{doc}` | {f_info['summary']} | {f_info['lifecycle']} |\n"
