...
_Generated by `tools/audit_repo_hygiene.py` on 2026-06-16 02:11:10_

## 1. Hygiene Status
- **Git Tracked Files:** 301
- **Stray Locals (Untracked):** 1055
- **Missing Locally:** 0
- **Stale Governed Files (>6 months):** 2

## 2. Hard Violations (Blocks CI)
- ❌ Untracked file in governed directory: tools/hardware_check.py
