...
_Generated by `tools/audit_repo_hygiene.py` on 2026-06-12 12:19:25_

## 1. Hygiene Status
- **Git Tracked Files:** 235
- **Stray Locals (Untracked):** 1831
- **Missing Locally:** 0
- **Stale Governed Files (>6 months):** 2

## 2. Hard Violations (Blocks CI)
- ❌ Untracked file in governed directory: tools/alert_beep.py
- ❌ Untracked file in governed directory: docs/space/conversation_with_nina.md
