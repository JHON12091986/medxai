...
_Generated by `tools/audit_repo_hygiene.py` on 2026-06-16 00:39:34_

## 1. Hygiene Status
- **Git Tracked Files:** 291
- **Stray Locals (Untracked):** 1021
- **Missing Locally:** 0
- **Stale Governed Files (>6 months):** 3
...
- ⚠️ `tools/provider_health.py` (Consider archival or check if dead code)
