...
_Generated by `tools/audit_repo_hygiene.py` on 2026-06-13 04:24:29_

## 1. Hygiene Status
- **Git Tracked Files:** 243
- **Stray Locals (Untracked):** 1872
- **Missing Locally:** 0
- **Stale Governed Files (>6 months):** 2

## 2. Hard Violations (Blocks CI)
- ❌ Untracked file in governed directory: docs/jules_pipeline.md
- ❌ Untracked file in governed directory: tools/jules.py
