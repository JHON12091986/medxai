...
_Generated by `tools/audit_repo_hygiene.py` on 2026-06-13 00:20:01_

## 1. Hygiene Status
- **Git Tracked Files:** 244
- **Stray Locals (Untracked):** 1854
- **Missing Locally:** 0
- **Stale Governed Files (>6 months):** 2

## 2. Hard Violations (Blocks CI)
- ❌ Untracked file in governed directory: tools/gemini_wrapper.sh
