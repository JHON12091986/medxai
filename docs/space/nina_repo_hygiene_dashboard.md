...
_Generated by `tools/audit_repo_hygiene.py` on 2026-06-12 21:50:38_

## 1. Hygiene Status
- **Git Tracked Files:** 237
- **Stray Locals (Untracked):** 1837
- **Missing Locally:** 0
- **Stale Governed Files (>6 months):** 2

## 2. Hard Violations (Blocks CI)
- ❌ Untracked file in governed directory: tools/gemini_watch.py
