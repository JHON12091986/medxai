...
<<<<<<< Updated upstream
_Generated by `tools/audit_repo_hygiene.py` on 2026-06-14 18:00:34_

## 1. Hygiene Status
- **Git Tracked Files:** 269
- **Stray Locals (Untracked):** 2027
=======
_Generated by `tools/audit_repo_hygiene.py` on 2026-06-14 20:04:00_

## 1. Hygiene Status
- **Git Tracked Files:** 273
- **Stray Locals (Untracked):** 848
>>>>>>> Stashed changes
- **Missing Locally:** 0
...
<<<<<<< Updated upstream
- ❌ Untracked file in governed directory: tools/nina_hud.py
=======
- ❌ Untracked file in governed directory: tools/dependency_mapper.py
>>>>>>> Stashed changes
