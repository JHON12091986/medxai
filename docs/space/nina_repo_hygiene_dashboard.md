...
_Generated by `tools/audit_repo_hygiene.py` on 2026-06-13 23:50:16_

## 1. Hygiene Status
- **Git Tracked Files:** 248
- **Stray Locals (Untracked):** 1968
- **Missing Locally:** 0
- **Stale Governed Files (>6 months):** 2

## 2. Hard Violations (Blocks CI)
- ❌ Untracked file in governed directory: docs/space/jules_queue.md
