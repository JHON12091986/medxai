...
_Generated by `tools/audit_repo_hygiene.py` on 2026-06-11 01:35:52_

## 1. Hygiene Status
- **Git Tracked Files:** 189
- **Stray Locals (Untracked):** 1657
- **Missing Locally:** 0
- **Stale Governed Files (>6 months):** 0

## 2. Hard Violations (Blocks CI)
- ❌ Untracked file in governed directory: docs/space/nina_repo_hygiene_dashboard.md
- ❌ Untracked file in governed directory: tools/audit_repo_hygiene.py
