...
_Generated by `tools/audit_repo_hygiene.py` on 2026-06-16 01:09:32_

## 1. Hygiene Status
- **Git Tracked Files:** 295
- **Stray Locals (Untracked):** 1044
- **Missing Locally:** 0
- **Stale Governed Files (>6 months):** 2

## 2. Hard Violations (Blocks CI)
- ❌ Untracked file in governed directory: tools/post_task_hook.py
- ❌ Untracked file in governed directory: tools/telegram_notify.py
