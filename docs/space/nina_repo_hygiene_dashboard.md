...
_Generated by `tools/audit_repo_hygiene.py` on 2026-06-11 03:35:08_

## 1. Hygiene Status
- **Git Tracked Files:** 187
- **Stray Locals (Untracked):** 1659
- **Missing Locally:** 0
- **Stale Governed Files (>6 months):** 0

## 2. Hard Violations (Blocks CI)
- ❌ Untracked file in governed directory: docs/space/AGENTS.md
- ❌ Untracked file in governed directory: docs/space/WORKFLOW.md
