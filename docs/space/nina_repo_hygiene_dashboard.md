...
_Generated by `tools/audit_repo_hygiene.py` on 2026-06-16 00:04:07_

## 1. Hygiene Status
- **Git Tracked Files:** 290
- **Stray Locals (Untracked):** 1002
- **Missing Locally:** 0
...
- ⚠️ `core/prompt_cache.py` (Consider archival or check if dead code)
