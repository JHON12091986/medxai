...
_Generated by `tools/audit_repo_hygiene.py` on 2026-06-14 17:33:35_

## 1. Hygiene Status
- **Git Tracked Files:** 268
- **Stray Locals (Untracked):** 2025
- **Missing Locally:** 1
- **Stale Governed Files (>6 months):** 2

## 2. Hard Violations (Blocks CI)
- ❌ Missing locally (corrupted worktree): jules_backlog_full.tmp
- ❌ Untracked file in governed directory: tools/context_pruner.py
