...
- `guardian_engine.py` — 1778 lines — last modified: 2026-05-23 22:06:27
...
> Last modified: 2026-05-23 22:06:27 | Lines: 1778
...
def run_engine(args):
    ...
    # ── Suggested actions ─────────────────────────────────────────────────────
    suggested_actions = build_suggested_actions(effective_findings, service_state, baseline_drift)
