...
- self.http vs self._http mismatch — ROOT CAUSE of all-providers-unavailable (R-72)
...
- Portfolio: aibony.github.io — single-page, dark mode, built Jun 2026

## Session Start Protocol
1. Check nina_update_log.md for last entry date and current version
2. Check nina_problem_log.md for any BLOCKING open issues
3. Confirm today's goal against Phase 1 roadmap
4. Run `./guardian` before touching any code
