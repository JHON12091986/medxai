...
- `guardian_engine.py` — 1779 lines — last modified: 2026-05-23 22:17:12
...
> Last modified: 2026-05-23 22:17:12 | Lines: 1779
...
def match_signatures(log_text, env_keys, py_file_texts):
    """
    Match signatures against runtime evidence first.
    Source files are not scanned wholesale because that creates false positives
    from signature definitions, fix strings, and comments.
    """
    findings = []
