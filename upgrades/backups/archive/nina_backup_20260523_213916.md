...
- `guardian_engine.py` — 1774 lines — last modified: 2026-05-23 21:34:37
...
- `tools/shell.py` — 72 lines — last modified: 2026-05-23 00:07:33
...
> Last modified: 2026-05-23 21:34:37 | Lines: 1774
...
def inspect_service_state(journal_recent, journal_15min):
    ...
    # Crash loop: more than 2 restarts in last 60 seconds
...
def run_engine(args):
    ...
    deploy_blocked = bool(blockers) or env_blocker or not service_state["active"]
    if blockers or env_blocker:
        overall_status = "FAIL"
...
> Last modified: 2026-05-23 00:07:33 | Lines: 72
