...
## File Contents
### AGENTS.md
Last modified: 2026-06-12 01:48:37
Size: 16389 bytes
```markdown
...
### docs/guardian.md
Last modified: 2026-06-12 01:56:12
Size: 3331 bytes
```markdown
...
### docs/memory.md
Last modified: 2026-06-12 00:00:57
Size: 3236 bytes
```markdown
# Memory Subsystem
...
### docs/ninaflash.md
Last modified: 2026-06-12 01:55:48
Size: 8203 bytes
```markdown
...
Last modified: 2026-06-12 01:57:08
Size: 1942 bytes
```markdown
...
Last modified: 2026-06-12 01:56:00
Size: 3649 bytes
```markdown
...
### docs/router.md
Last modified: 2026-06-12 01:56:39
Size: 4492 bytes
```markdown
...
Last modified: 2026-06-12 01:57:59
Size: 19673 bytes
```markdown
...
## 1. Snapshot
- Generated: 2026-06-12 01:57 +06
- Git HEAD: 2b662305ab9f01c42ccafdb1d5f2bef75ea94588
- Last commit: docs: post-session sync 2026-06-12 01:56
- Service: activating
unknown
```
● nina.service - NINA Autonomous Agent
     Loaded: loaded (/etc/systemd/system/nina.service; enabled; preset: enabled)
     Active: activating (auto-restart) (Result: exit-code) since Fri 2026-06-12 01:57:51 +06; 3s ago
 Invocation: c585f10d049e48df9461e57ff513a817
    Process: 237298 ExecStart=/home/aibony/nina/venv/bin/python main.py (code=exited, status=1/FAILURE)
   Main PID: 237298 (code=exited, status=1/FAILURE)
   Mem peak: 27.8M
        CPU: 210ms
unavailable
```
...
```
2b66230 docs: post-session sync 2026-06-12 01:56
